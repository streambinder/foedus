...
var translations = map[string]map[string]string{
	"en": {
		...
		"home.soundtrack_readonly_description": "The playlist for the big day is ready — press play and enjoy!",
		...
		"label.playlist_readonly":              "Read-only playlist",
	...
	"it": {
		...
		"home.soundtrack_readonly_description": "La playlist del grande giorno è pronta — premi play e goditela!",
		...
		"label.playlist_readonly":              "Playlist in sola lettura",
		"placeholder.playlist_url":             "https://open.spotify.com/playlist/...",
...
var HomepageKeys = []string{
	...
	"home.soundtrack", "home.soundtrack_description", "home.soundtrack_readonly_description",
