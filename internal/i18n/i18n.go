...
var translations = map[string]map[string]string{
	"en": {
		...
		"invitation.event_passed":      "This event has already taken place — thank you for being part of it.",
		...
		"home.soundtrack_event_passed_description": "The big day is over — press play and enjoy the playlist!",
	...
	"it": {
		...
		"invitation.event_passed":      "Questo evento si è già svolto — grazie per averne fatto parte.",
		...
		"home.soundtrack_event_passed_description": "Il grande giorno è passato — premi play e goditi la playlist!",
...
var HomepageKeys = []string{
	...
	"home.soundtrack", "home.soundtrack_description", "home.soundtrack_event_passed_description",
